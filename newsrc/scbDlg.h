...
class CScbDlg : public CDialog, public Solver_Callback
{
// Construction
   public:
      void process_result(const Mono_Solver& solver);
...
// Dialog Data
      ...
      enum Solver_State state() const
      {
         return solver_state;
      }
      BOOL preserve_original_format()
      {
         return m_preserve_original_format;
      }
      BOOL remove_punctuation()
      {
         return m_remove_punctuation;
      }
