...
void CNgraphCreatorDialog::process_progress(const Ngraph_File_Creator& creator)
{
   m_progress = creator.get_progress();
   SendMessage(M_CREATORCALLBACK, FALSE, 0);
}
